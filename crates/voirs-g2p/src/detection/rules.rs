...
use crate::detection::{DetectionResult, DetectionMethod, get_language_indicators};
...
impl RuleBasedDetector {
    ...
    fn load_english_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::EnUs, CharPattern {
        ...
        self.word_patterns.insert(LanguageCode::EnUs, WordPattern {
            indicators,
            function_words: vec![
    ...
    fn load_german_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::De, CharPattern {
            frequencies: char_freq,
            ranges: vec![
                (0x0041, 0x005A), (0x0061, 0x007A), // Basic Latin
                (0x00C4, 0x00C4), (0x00D6, 0x00D6), (0x00DC, 0x00DC), // Ä, Ö, Ü
                (0x00E4, 0x00E4), (0x00F6, 0x00F6), (0x00FC, 0x00FC), // ä, ö, ü
                (0x00DF, 0x00DF), // ß
            ],
        });
        ...
        self.word_patterns.insert(LanguageCode::De, WordPattern {
            indicators,
            function_words: vec![
                "der".to_string(), "die".to_string(), "das".to_string(), "und".to_string(),
                "in".to_string(), "den".to_string(), "von".to_string(), "zu".to_string(),
            ],
        });
    }
    ...
    fn load_french_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::Fr, CharPattern {
            frequencies: char_freq,
            ranges: vec![
                (0x0041, 0x005A), (0x0061, 0x007A), // Basic Latin
        ...
        self.word_patterns.insert(LanguageCode::Fr, WordPattern {
            indicators,
            function_words: vec![
                "le".to_string(), "de".to_string(), "et".to_string(), "à".to_string(),
                "un".to_string(), "il".to_string(), "être".to_string(), "en".to_string(),
            ],
        });
    }
    ...
    fn load_spanish_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::Es, CharPattern {
            frequencies: char_freq,
            ranges: vec![
                (0x0041, 0x005A), (0x0061, 0x007A), // Basic Latin
                (0x00C1, 0x00C1), (0x00C9, 0x00C9), (0x00CD, 0x00CD), // Á, É, Í
                (0x00D1, 0x00D1), (0x00D3, 0x00D3), (0x00DA, 0x00DA), // Ñ, Ó, Ú
                (0x00DC, 0x00DC), // Ü
                (0x00E1, 0x00E1), (0x00E9, 0x00E9), (0x00ED, 0x00ED), // á, é, í
                (0x00F1, 0x00F1), (0x00F3, 0x00F3), (0x00FA, 0x00FA), // ñ, ó, ú
                (0x00FC, 0x00FC), // ü
            ],
        });
        ...
        self.word_patterns.insert(LanguageCode::Es, WordPattern {
            indicators,
            function_words: vec![
                "el".to_string(), "la".to_string(), "de".to_string(), "que".to_string(),
                "y".to_string(), "a".to_string(), "en".to_string(), "un".to_string(),
            ],
        });
    }
    ...
    fn load_japanese_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::Ja, CharPattern {
            frequencies: char_freq,
            ranges: vec![
        ...
        self.word_patterns.insert(LanguageCode::Ja, WordPattern {
            indicators,
            function_words: vec![
                "の".to_string(), "に".to_string(), "は".to_string(), "を".to_string(),
                "が".to_string(), "で".to_string(), "て".to_string(), "と".to_string(),
            ],
        });
    }
    ...
    fn load_chinese_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::ZhCn, CharPattern {
            frequencies: char_freq,
            ranges: vec![
                (0x4E00, 0x9FFF), // CJK Unified Ideographs
            ],
        ...
        self.word_patterns.insert(LanguageCode::ZhCn, WordPattern {
            indicators,
            function_words: vec![
                "的".to_string(), "一".to_string(), "是".to_string(), "在".to_string(),
                "不".to_string(), "了".to_string(), "有".to_string(), "和".to_string(),
            ],
        });
    }
    ...
    fn load_korean_patterns(&mut self) {
        ...
        self.char_patterns.insert(LanguageCode::Ko, CharPattern {
            frequencies: char_freq,
            ranges: vec![
        ...
        self.word_patterns.insert(LanguageCode::Ko, WordPattern {
            indicators,
            function_words: vec![
                "이".to_string(), "의".to_string(), "가".to_string(), "을".to_string(),
                "는".to_string(), "에".to_string(), "하".to_string(), "고".to_string(),
            ],
        });
    }
    ...
    pub fn detect(&self, text: &str) -> Result<Option<DetectionResult>> {
        ...
        for &language in &[
            LanguageCode::EnUs, LanguageCode::De, LanguageCode::Fr, 
            LanguageCode::Es, LanguageCode::Ja, LanguageCode::ZhCn, 
            LanguageCode::Ko
        ] {
        ...
        if let Some((language, confidence)) = best_match {
            if confidence > 0.3 { // Minimum threshold for rule-based detection
...
mod tests {
    ...
    fn test_english_detection() {
        ...
        let result = detector.detect("The quick brown fox jumps over the lazy dog").unwrap();
    ...
    fn test_german_detection() {
        ...
        let result = detector.detect("Der schnelle braune Fuchs springt über den faulen Hund").unwrap();
        if let Some(result) = result {
