...
impl MixedLanguageDetector {
    ...
    fn should_split_scripts(&self, script1: ScriptType, script2: ScriptType) -> bool {
        ...
        match (script1, script2) {
            ...
            (ScriptType::Unknown, _) | (_, ScriptType::Unknown) |
            (ScriptType::Mixed, _) | (_, ScriptType::Mixed) => false,
...
mod tests {
    ...
    fn test_mixed_detection() {
        ...
        let result = detector.detect_mixed("Hello world. This is English text.").unwrap();
    ...
    fn test_single_language_text() {
        ...
        let result = detector.detect("This is purely English text without any other languages").unwrap();
