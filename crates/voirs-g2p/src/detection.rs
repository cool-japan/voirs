...
static LANGUAGE_INDICATORS: LazyLock<HashMap<LanguageCode, Vec<&'static str>>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    
    // English indicators
    map.insert(LanguageCode::EnUs, vec![
        "the", "and", "of", "to", "a", "in", "is", "it", "you", "that",
        "he", "was", "for", "on", "are", "as", "with", "his", "they", "I"
    ]);
    
    // German indicators  
    map.insert(LanguageCode::De, vec![
        "der", "die", "und", "in", "den", "von", "zu", "das", "mit", "sich",
        "des", "auf", "für", "ist", "im", "dem", "nicht", "ein", "eine", "als"
    ]);
    
    // French indicators
    map.insert(LanguageCode::Fr, vec![
        "le", "de", "et", "à", "un", "il", "être", "et", "en", "avoir",
        "que", "pour", "dans", "ce", "son", "une", "sur", "avec", "ne", "se"
    ]);
    
    // Spanish indicators
    map.insert(LanguageCode::Es, vec![
        "el", "la", "de", "que", "y", "a", "en", "un", "es", "se",
        "no", "te", "lo", "le", "da", "su", "por", "son", "con", "para"
    ]);
    
    // Japanese indicators (hiragana)
    map.insert(LanguageCode::Ja, vec![
        "の", "に", "は", "を", "た", "が", "で", "て", "と", "し",
        "れ", "さ", "ある", "いる", "も", "する", "から", "な", "こと", "として"
    ]);
    
    // Chinese indicators (simplified)
    map.insert(LanguageCode::ZhCn, vec![
        "的", "一", "是", "在", "不", "了", "有", "和", "人", "这",
        "中", "大", "为", "上", "个", "国", "我", "以", "要", "他"
    ]);
    
    // Korean indicators
    map.insert(LanguageCode::Ko, vec![
        "이", "의", "가", "을", "는", "에", "하", "고", "를", "으로",
        "로", "에서", "와", "한", "까지", "도", "만", "부터", "께", "에게"
    ]);
...
pub fn get_language_indicators(language: LanguageCode) -> Option<&'static Vec<&'static str>> {
    LANGUAGE_INDICATORS.get(&language)
}
